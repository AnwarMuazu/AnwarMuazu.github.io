...
function w3sElementAddClass(elm, className) {
  if (!elm) {
    return;
  }
      ...
      if (d.indexOf(aa) >= 0 || bb) {
        ...
        if (y && (y.className.indexOf("ref_overview") > -1 || y.className.indexOf("tut_overview") > -1)) {
          ...
          if (y.className.indexOf("tut_overview") > -1) {
            ...
            w3sElementAddClass(y.getElementsByTagName("a")[0], "active");
          } else if (y.className.indexOf("ref_overview") > -1) {
            w3sElementAddClass(x[i], "active_overview");
            w3sElementAddClass(y.getElementsByTagName("a")[0], "active");
          }
